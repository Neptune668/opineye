...
import "../../index.js";
//#region src/modal/src/presetProps.d.ts
declare const presetProps: {
  ...
  segmented: {
    readonly type: import("vue").PropType<boolean | CardSegmented>;
    readonly default: false;
  };
  size: import("vue").PropType<CardSize>;
...
declare const presetPropsKeys: ("loading" | "footer" | "title" | "type" | "content" | "contentClass" | "contentStyle" | "bordered" | "size" | "cover" | "icon" | "tag" | "iconPlacement" | "showIcon" | "closable" | "onClose" | "contentScrollable" | "headerClass" | "headerStyle" | "headerExtraClass" | "headerExtraStyle" | "footerClass" | "footerStyle" | "embedded" | "segmented" | "hoverable" | "role" | "action" | "headerExtra" | "closeFocusable" | "negativeText" | "positiveText" | "positiveButtonProps" | "negativeButtonProps" | "titleClass" | "titleStyle" | "actionClass" | "actionStyle" | "onPositiveClick" | "onNegativeClick")[];
//#endregion
