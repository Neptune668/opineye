...
//#region src/dialog/src/dialogProps.d.ts
...
type DialogProps = ExtractPublicPropTypes<typeof dialogProps>;
declare const dialogPropKeys: ("loading" | "title" | "type" | "content" | "contentClass" | "contentStyle" | "bordered" | "icon" | "iconPlacement" | "showIcon" | "closable" | "onClose" | "action" | "closeFocusable" | "negativeText" | "positiveText" | "positiveButtonProps" | "negativeButtonProps" | "titleClass" | "titleStyle" | "actionClass" | "actionStyle" | "onPositiveClick" | "onNegativeClick")[];
//#endregion
export { DialogProps, dialogPropKeys, dialogProps };